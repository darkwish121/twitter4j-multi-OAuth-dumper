 ...
 * Lists Followers ids
 *
 * @author Sohail Ahmed - sohail.ahmed121 at gmail.com
 */
public final class FilesThreaderFollowersIDsParser {
    ...
    public static void main(String[] args) throws ClassNotFoundException,
        ...
        try {
            ...
            for (String myFile : myFilesShare) {
                ...
                try (BufferedReader br = new BufferedReader(new FileReader(
                    ...
                    while ((line = br.readLine()) != null) {
                        ...
                        System.out
                                .println("Going to get followers ids of Screen-name / user_id: "
                                        + line);
                        System.out.println();
                        ...
                        do {
                            ...
                            try {
                                ...
                                if (te.getStatusCode() == HttpResponseCode.UNAUTHORIZED
                                    ...
                                    System.out
                                            .println("Followers Get Exception: "
                                                    + te.getMessage());
                                }
            ...
            // te.printStackTrace();
            System.err.println("Failed to get followers' ids: "
                    + te.getMessage());
            System.exit(-1);
        }
