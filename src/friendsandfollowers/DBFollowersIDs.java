 ...
 */
public final class DBFollowersIDs {
    ...
    public static void main(String[] args) throws ClassNotFoundException,
        ...
        try {
            ...
            if (StringUtils.isEmpty(targetedUser)) {
                ...
                String selectQuery = "SELECT * FROM `followers_parent` WHERE "
                        + "`targeteduser` != '' AND "
                        + "`nextcursor` != '0' AND "
                        + "`nextcursor` != '2'";
                    ...
                    do {
                        ...
                        try {
                            ...
                            if (chckedNumaric) {
                                ...
                                long LongValueTargetedUser = 
                                        Long.valueOf(targetedUser).longValue();

                                ids = twitter.getFollowersIDs(
                                        LongValueTargetedUser,
                                        cursor);
                            } else {
                                ids = twitter.getFollowersIDs(targetedUser,
                                        cursor);
                            }
                            ...
                            if (te.getStatusCode() == HttpResponseCode.UNAUTHORIZED
                                ...
                                System.out.println("Followers Get Exception: "
                                        + te.getMessage());
                            }
                ...
                do {
                    ...
                    try {
                        ...
                        if (chckedNumaric) {
                            ...
                            ids = twitter.getFollowersIDs(LongValueTargetedUser,
                                    cursor);
                        } else {
                            ids = twitter.getFollowersIDs(targetedUser,
                                    cursor);
