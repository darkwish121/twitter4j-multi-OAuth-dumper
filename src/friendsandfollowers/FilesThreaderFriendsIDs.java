 ...
 */
public class FilesThreaderFriendsIDs {
    ...
    public FilesThreaderFriendsIDs() {
        runnable = true;
    }
            ...
            threadPool.submit(new Runnable() {
                ...
                public void run() {
	                ...
	                ((ThreadPrintStream)System.out).setThreadOut(stream);
                        ...
                        FilesThreaderFriendsIDs.execTask(
                                INPUT, 
                                OUTPUT, 
                                TOTAL_JOBS_STR, 
                                JOB_NO, 
    ...
    public static void execTask(String INPUT, 
        ...
        String[] args = {INPUT, OUTPUT, TOTAL_JOBS_STR, JOB_NO, PAUSE, 
            IDS_TO_FETCH};
        friendsandfollowers.FilesThreaderFriendsIDsParser.main(args);
